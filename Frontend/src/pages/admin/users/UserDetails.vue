  ...
  <div class="space-y-6 font-['Manrope'] text-[#191c1e] pb-10">
    ...
    <div class="flex flex-col sm:flex-row justify-between sm:items-end gap-4 mb-6">
      <div class="flex flex-col gap-1">
        <h1 class="text-3xl font-extrabold tracking-tight text-[#191c1e]">Customer Details</h1>
        <p class="text-sm text-[#727687]">Profile summary and vehicle rental history of the customer.</p>
      </div>
    ...
    <div v-if="isLoading" class="p-20 text-center bg-white rounded-3xl border border-[#c2c6d8]/40 shadow-sm">
        ...
        <p class="text-[#727687] font-bold text-sm uppercase tracking-widest">Loading User Profile...</p>
    </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-gradient-to-br from-[#003161] to-[#0050cb] text-white p-6 md:p-8 rounded-3xl shadow-md flex flex-col justify-center relative overflow-hidden group">
          <div class="relative z-10">
            <p class="text-[#b3c5ff] text-[10px] md:text-xs font-bold uppercase tracking-widest mb-2">Total Revenue from User</p>
        ...
        <div class="bg-white border border-[#c2c6d8]/40 p-6 md:p-8 rounded-3xl shadow-sm flex flex-col justify-center">
          <p class="text-[#727687] text-[10px] md:text-xs font-bold uppercase tracking-widest mb-2">Total Vehicle Rentals</p>
          <div class="flex items-center gap-3">
            ...
            <h3 class="text-3xl font-black text-[#191c1e] tracking-tighter">{{ stats.total_orders || 0 }} <span class="text-lg text-[#727687] font-bold">Times</span></h3>
          </div>
        </div>

        <!-- Member Sejak -->
        <div class="bg-white border border-[#c2c6d8]/40 p-6 md:p-8 rounded-3xl shadow-sm flex flex-col justify-center">
          <p class="text-[#727687] text-[10px] md:text-xs font-bold uppercase tracking-widest mb-2">Member Since</p>
          <div class="flex items-center gap-3">
            <span class="w-10 h-10 rounded-full bg-[#f2f4f6] flex items-center justify-center">
      ...
      <div class="flex flex-col rounded-3xl border border-[#c2c6d8]/40 bg-white shadow-sm overflow-hidden">
        ...
        <div class="p-6 md:p-8 border-b border-[#f2f4f6] bg-[#f7f9fb]/50">
          <div class="flex items-center gap-3 mb-6">
            ...
            <h2 class="text-lg md:text-xl font-extrabold text-[#191c1e]">Customer Profile</h2>
          </div>
        ...
        <div class="p-6 md:p-8">
          <div class="flex items-center gap-3 mb-6">
            ...
            <h2 class="text-lg md:text-xl font-extrabold text-[#191c1e]">Recent Rental History</h2>
          </div>
            ...
            <table class="w-full text-left whitespace-nowrap min-w-[700px]">
              <thead class="bg-[#f2f4f6] text-[#727687] uppercase text-[10px] font-black tracking-widest border-y border-[#c2c6d8]/40">
                <tr>
                  ...
                  <th class="px-6 py-4">VEHICLE & DATE</th>
                  <th class="px-6 py-4 text-center">DURATION</th>
                  <th class="px-6 py-4 text-right">BILL</th>
                  ...
                  <td class="px-6 py-5 text-center">
                    ...
                    >
                      ...
                      {{
                        ...
                        order.status === 'active' ? 'RENTED' : 'CANCELLED'
                      }}
                    </span>
                  </td>
                </tr>
