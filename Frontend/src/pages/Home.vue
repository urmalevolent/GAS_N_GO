      ...
      <div class="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
        ...
        <div class="space-y-8">
          ...
          <h1 class="text-[3rem] sm:text-[4rem] lg:text-[5rem] font-black leading-[1.1] text-[#111827] tracking-tight uppercase">
            Drive The <br />
            <span class="text-[#0d6efd]">Unimaginable</span>
          </h1>
          
          <!-- Deskripsi -->
          <p class="text-slate-600 text-lg sm:text-xl max-w-lg leading-relaxed">
            Experience the pinnacle of automotive engineering with our curated collection of world-class supercars and luxury sedans.
          </p>
          
          <!-- Tombol -->
          <div class="flex flex-col sm:flex-row gap-4">
            <button class="bg-[#0d6efd] hover:bg-blue-700 text-white font-bold px-8 py-3.5 rounded shadow-lg shadow-blue-500/30 transition-all uppercase tracking-wide text-sm">
              Explore Fleet
            </button>
            <button class="bg-blue-50 hover:bg-blue-100 text-blue-700 font-bold px-8 py-3.5 rounded transition-all uppercase tracking-wide text-sm">
              View Services
            </button>
          </div>
        </div>
        ...
        <div class="relative mt-10 lg:mt-0">
          ...
          <div class="absolute -bottom-6 -left-2 sm:-left-8 bg-white p-4 rounded-xl shadow-xl flex items-center gap-4 animate-bounce-slow">
            ...
            <div>
              <p class="text-[10px] font-bold text-slate-400 uppercase tracking-wider">New Arrival</p>
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-16 relative z-20">
      <div class="bg-white rounded-xl shadow-xl p-2 sm:p-4 flex flex-col lg:flex-row items-center divide-y lg:divide-y-0 lg:divide-x divide-gray-100">
        ...
        <div class="w-full lg:w-1/3 p-4 flex flex-col justify-center">
          <label class="text-[11px] font-bold text-slate-400 uppercase tracking-wider mb-1">Pickup Location</label>
          <div class="flex items-center gap-3 text-slate-800 font-medium">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="blue" class="w-5 h-5"><path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" /><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1 1 15 0Z" /></svg>
            <input type="text" placeholder="Select City" class="w-full outline-none bg-transparent placeholder-slate-800" />
          </div>
        </div>

        <!-- Pickup Date -->
        <div class="w-full lg:w-1/3 p-4 flex flex-col justify-center">
          <label class="text-[11px] font-bold text-slate-400 uppercase tracking-wider mb-1">Pickup Date</label>
          <div class="flex items-center gap-3 text-slate-800 font-medium">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="blue" class="w-5 h-5"><path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5" /></svg>
            <input type="text" placeholder="mm / dd / yyyy" class="w-full outline-none bg-transparent placeholder-slate-800" />
          </div>
        </div>
        ...
        <div class="w-full lg:w-1/3 p-4 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div class="w-full">
            <label class="text-[11px] font-bold text-slate-400 uppercase tracking-wider mb-1">Car Type</label>
            <div class="flex items-center justify-between text-slate-800 font-medium cursor-pointer">
              <div class="flex items-center gap-3">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="blue" class="w-5 h-5"><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 18.75a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 0 1-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 0 0-3.213-9.193 2.056 2.056 0 0 0-1.58-.86H14.25M16.5 18.75h-2.25m0-11.177v-.958c0-.568-.422-1.048-.987-1.106a48.554 48.554 0 0 0-10.026 0 1.106 1.106 0 0 0-.987 1.106v7.635m12-6.677v6.677m0 4.5v-4.5m0 0h-12" /></svg>
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-32 mb-10">
      <div class="max-w-2xl">
        <h2 class="text-3xl md:text-4xl lg:text-[40px] font-black text-[#111827] uppercase leading-none mb-4">
          Redefining The Standard Of Luxury Mobility.
        </h2>
        <p class="text-slate-600 text-lg leading-relaxed">
          We don't just provide cars; we provide seamless experiences tailored to the most discerning drivers.
        </p>
      </div>
    </section>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 bg-[#f0f2f5] rounded-3xl p-8 lg:p-10 flex flex-col md:flex-row items-center gap-8 group">
          <div class="flex-1 space-y-4">
            ...
            <h3 class="text-2xl font-bold text-slate-900">White-Glove Concierge</h3>
            <p class="text-slate-600 leading-relaxed">
              Dedicated logistics experts ensuring your vehicle is delivered and collected at your convenience, anywhere in the metropolitan area.
            </p>
          </div>
          <div class="w-full md:w-1/2 overflow-hidden rounded-2xl">
            <img :src="carhome1" alt="Handing over keys" class="w-full h-48 lg:h-64 object-cover group-hover:scale-105 transition-transform duration-500 grayscale">
          </div>
        </div>
        ...
        <div class="bg-[#0d6efd] rounded-3xl p-8 lg:p-10 flex flex-col justify-center text-white">
          ...
          <h3 class="text-2xl font-bold mb-4">Zero-Lag Booking</h3>
          <p class="text-blue-100 leading-relaxed">
            Our digital-first approach means you're behind the wheel in under 5 minutes. No paperwork, just performance.
          </p>
        </div>
        ...
        <div class="bg-white rounded-3xl p-8 lg:p-10 shadow-sm border border-gray-100 flex flex-col justify-center">
          ...
          <h3 class="text-2xl font-bold text-slate-900 mb-4">The Elite Fleet</h3>
          <p class="text-slate-600 leading-relaxed">
            Only current-year models with bespoke specifications. We maintain the highest standards of perfection.
          </p>
        </div>
        ...
        <div class="lg:col-span-2 bg-[#f0f2f5] rounded-3xl p-8 lg:p-10 flex flex-col md:flex-row items-center gap-8 group">
          <div class="flex-1 space-y-4">
            ...
            <h3 class="text-2xl font-bold text-slate-900">Infinite Freedom</h3>
            <p class="text-slate-600 leading-relaxed">
              Unlimited mileage on select luxury models and inter-city drop-off options for your continental journeys.
            </p>
          </div>
          <div class="w-full md:w-1/2 overflow-hidden rounded-2xl">
            <img src="https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?q=80&w=800&auto=format&fit=crop" alt="Coastal Road" class="w-full h-48 lg:h-56 object-cover group-hover:scale-105 transition-transform duration-500">
          </div>
        </div>
    ...
    <section class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mt-24">
      <div class="bg-white rounded-[40px] shadow-sm py-16 px-6 sm:px-12 text-center border border-gray-100">
        <h2 class="text-3xl md:text-4xl lg:text-[42px] font-black text-[#111827] uppercase leading-tight mb-4">
          Ready To Transform <br class="hidden sm:block" /> Your Perspective?
        </h2>
        <p class="text-slate-500 text-lg mb-8 max-w-xl mx-auto">
          Join the LUXE DRIVE inner circle for exclusive access to new arrivals and members-only events.
        </p>
        ...
        <form @submit.prevent class="flex flex-col sm:flex-row justify-center gap-3 max-w-lg mx-auto">
          ...
          />
          <button type="submit" class="bg-[#0d6efd] hover:bg-blue-700 text-white font-bold px-8 py-4 rounded-md uppercase text-sm tracking-wide transition-colors">
            Join Circle
          </button>
        </form>
      </div>
